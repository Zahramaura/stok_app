...
class barangKeluarcontroller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->filled('tanggak_awal') && $request->filled('tanggal_akhir')) {
    ...
    public function create()
    {
        ...
        return view('Barang.barangKeluar.add-barangKeluar');
    }
    ...
    public function saveprocess(Request $request){
        ...
        $getStokData = stok::find($request->barang_id);
            ...
            if ($diskon) {
                ...
                $hitung = $request->jumlah_beli * $request->harap_jual;
            ...
            return redirect('/barangKeluar')->with(
                'message',
